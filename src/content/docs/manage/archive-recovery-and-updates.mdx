...
Jean also tracks CLI versions separately from the app. When a supported backend CLI (Claude, Codex, OpenCode, Cursor, PI, Command Code) has an update, Jean shows a CLI update modal so you can refresh the backend without leaving the app.
