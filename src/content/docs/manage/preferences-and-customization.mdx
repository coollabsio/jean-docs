...
Codex, OpenCode, PI, and Grok also expose auto-steer toggles here. When enabled, plain follow-up prompts can be injected into an active turn instead of waiting for the run to fully finish.
