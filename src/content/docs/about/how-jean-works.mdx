...
On Linux, Jean ships native window controls instead of relying on the system frame, so the chrome stays consistent across desktops.

## First-run tour

When Jean launches for the first time, a short feature tour walks you through the main areas of the app: sidebar, canvas, chat, magic menu, and preferences. You can dismiss it and reopen it later from the command palette.
