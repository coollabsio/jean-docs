...
You can use Claude CLI, Codex CLI, OpenCode, Cursor Agent, PI, Command Code, or a mix of them. Git is required. GitHub CLI and a Linear API key are optional, but they unlock more of the workflow.

## What you need

- Git
- At least one backend: Claude CLI, Codex CLI, OpenCode, Cursor Agent, PI, or Command Code
...
- authenticate Claude CLI, Codex CLI, GitHub CLI, OpenCode, Cursor Agent, PI, and Command Code
